...
class PublicUserApiTests(TestCase):
    ...
    def test_user_with_email_exists_error(self):
        """Test error returned if a duplicate user is created"""
        payload = {
            'email': 'test@example.com',
            'password': 'sample123',
            'name': 'Test User'
    ...
    def test_create_token_blank_pasword(self):
        """Test returns error if the password is blank"""
        payload = {
            'email': 'test@example.com',
            'password': 'pw',
        }
